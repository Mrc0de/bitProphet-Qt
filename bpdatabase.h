...
public:
    ...
    void getGdaxPriceHistoryFrom(QString coin,QString dateTimeFrom, int maxHours, QList<QString> *priceList,QList<QString> *askList,QList<QString> *bidList,QList<QString> *tsList);
